...
@endpush
@section('breadcrumb')
    <h6 class="h2 d-inline-block mb-0">{{__('Contract Type')}}</h6>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h3 class="mb-0">{{__('Contract Type')}}</h3>
                            </div>
                            @if(\Auth::user()->type=='company')
                                <div class="col-6 text-right">
                                    <span class="create-btn">
                                        <a href="#" data-url="{{ route('contractType.create') }}" data-ajax-popup="true" data-title="{{__('Create New Contract Type')}}" class="btn btn-outline-primary btn-sm">
                                ...
                                <tr class="font-style">
                                    ...
                                    @if(\Auth::user()->type=='company')
                                        <td class="action text-right">
                                            <a href="#" data-url="{{ route('contractType.edit',$type->id) }}" data-ajax-popup="true" data-title="{{__('Edit Contract Type')}}" class="table-action" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
