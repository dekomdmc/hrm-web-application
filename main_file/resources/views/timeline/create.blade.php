...
@endpush
@section('breadcrumb')
    <h6 class="h2 d-inline-block mb-0">{{__('Estimate Create')}}</h6>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('proposal_number', __('Invoice Number')) }}
                                    <input type="text" class="form-control" value="INV001" readonly>
                                </div>
                            </div>
