...
<script>
    ...
    function getClientProject(client_id) {
        $.ajax({
            url: "{{route('purchaseinvoice.client.project')}}",
            type: 'POST',
            data: {
                "client_id": client_id,
                "_token": "{{ csrf_token() }}",
...
@endpush
@section('breadcrumb')
<h6 class="h2 d-inline-block mb-0">{{__('Purchase Invoice')}}</h6>
<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
    <ol class="breadcrumb breadcrumb-links">
        <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>
        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
        <li class="breadcrumb-item active" aria-current="page">{{__('Purchase Invoice')}}</li>
    </ol>
</nav>
@endsection
@section('content')
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    {{ Form::open(array('url' => 'purchaseinvoice','method'=>'get')) }}
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col-auto apply-btn">
                            ...
                            <a href="{{route('purchaseinvoice.index')}}" class="btn btn-outline-danger btn-sm">{{__('Reset')}}</a>
                        </div>
                    </div>
                    {{ Form::close() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto">
                            <span class="create-btn">
                                ...
                                <a href="{{ route('purchaseinvoice.create') }}" data-url="{{ route('purchaseinvoice.create') }}" data-ajax-popup="true" data-title="{{__('Create New Invoice')}}" class="btn btn-outline-primary btn-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="table-actions text-right">
                                    ...
                                    <a href="#!" class="table-action table-action-delete" data-toggle="tooltip" data-original-title="{{__('Delete')}}" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="document.getElementById('purchaseinvoice-delete-form-{{$invoice->id}}').submit();">
                                        <i class="fas fa-trash"></i>
                                    </a>
                                    {!! Form::open(['method' => 'DELETE', 'route' => ['purchaseinvoice.destroy', $invoice->id],'id'=>'purchaseinvoice-delete-form-'.$invoice->id]) !!}
                                    {!! Form::close() !!}
                                    @endif
                                </td>
                            </tr>
