                                ...
                                <div data-v-f2a183a6="" class="d-header" style="background: {{$color}};color:{{$font_color}}">
                                    <div data-v-f2a183a6="" class="d-header-inner">
                                        ...
                                        <div data-v-f2a183a6="" class="d-header-50 d-right">
                                            <div data-v-f2a183a6="" class="d-title">{{__('ESTIMATE')}}</div>
                                            <table style="width: 200px" data-v-f2a183a6="" class="summary-table">
                                                <tbody data-v-f2a183a6="">
                                                    <tr>
                                                        <td>{{__('Number')}}:</td>
                                                        <td>{{\App\Utility::estimateNumberFormat($settings,$estimate->estimate)}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{__('Issue Date')}}:</td>
                                                        <td>{{\App\Utility::dateFormat($settings,$estimate->issue_date)}}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div data-v-363339a0="" class="d-table">
                                            <div data-v-363339a0="" class="d-table">
                                                <div data-v-f2a183a6="" class="d-table-tr" style="background: {{$color}};color:{{$font_color}}">
                                                    ...
                                                    <div class="d-table-th w-3">{{__('Unit Price')}}</div>
