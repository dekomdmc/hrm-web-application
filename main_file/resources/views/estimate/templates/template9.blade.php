                        ...
                        <div data-v-7d9d14b5="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-2"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('ESTIMATE')}}</h1>
                                        <h3 data-v-7d9d14b5="">{{\App\Utility::estimateNumberFormat($settings,$estimate->estimate)}}</h3>
                                        <p data-v-7d9d14b5="">{{\App\Utility::dateFormat($settings,$estimate->issue_date)}}</p>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="ship_to">
                                        ...
                                        <p>
                                            {{!empty($client->company_name)?$client->company_name:''}}<br>
                                ...
                                <div data-v-363339a0="" class="d-table">
                                    <div data-v-363339a0="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table-tr" style="color: {{$font_color}}; background: {{$color}};">
                                        ...
                                        <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                            ...
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{$estimate->totalQuantity}}</pre>
                                            </div>
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$estimate->totalRate)}}</pre>
                                            </div>
                                            <div class="d-table-td w-6">
                                                <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$estimate->totalTaxPrice) }}</pre>
                                            </div>
                                            @if($estimate->discount_apply==1)
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$estimate->totalDiscount)}}</pre>
                                                </div>
                                            @else
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">-</pre>
                                            ...
                                            <div class="d-table-td w-4 text-right">
                                                    <span>{{\App\Utility::priceFormat($settings,$estimate->getSubTotal())}}
                                                    </span>
                                            </div>
                                        </div>
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                @if($estimate->discount_apply==1)
                                                    @if($estimate->getTotalDiscount())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            ...
                                                            <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$estimate->getTotalDiscount())}}</div>
                                                        </div>
                                                    @endif
                                                @endif
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="color: {{$font_color}}; background: {{$color}};">
                                                    <div data-v-f2a183a6="" class="d-table-label">{{__('Total')}}:</div>
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$estimate->getSubTotal()-$estimate->getTotalDiscount()+$estimate->getTotalTax())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
