                        ...
                        <div data-v-4b3dcb8a="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid {{$color}};">
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-2"><h1 data-v-4b3dcb8a="" class="fancy-title mb5">{{__('ESTIMATE')}}</h1></div>
                                        ...
                                        <div class="d-table-body">
                                            @if(isset($estimate->items) && count($estimate->items) > 0)
                                                @foreach($estimate->items as $key => $item)
                                                    ...
                                                    <div class="d-table-tr" style="border-bottom:1px solid {{$color}};color: {{$font_color}}">
