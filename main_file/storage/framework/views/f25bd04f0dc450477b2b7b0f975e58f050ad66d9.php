                                ...
                                <div data-v-f2a183a6="" class="d-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                    <div data-v-f2a183a6="" class="d-header-inner">
                                        ...
                                        <div data-v-f2a183a6="" class="d-header-50 d-right">
                                            <div data-v-f2a183a6="" class="d-title"><?php echo e(__('ESTIMATE')); ?></div>
                                            <table style="width: 200px" data-v-f2a183a6="" class="summary-table">
                                                <tbody data-v-f2a183a6="">
                                                    <tr>
                                                        <td><?php echo e(__('Number')); ?>:</td>
                                                        <td><?php echo e(\App\Utility::estimateNumberFormat($settings,$estimate->estimate)); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td><?php echo e(__('Issue Date')); ?>:</td>
                                                        <td><?php echo e(\App\Utility::dateFormat($settings,$estimate->issue_date)); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div data-v-363339a0="" class="d-table">
                                            <div data-v-363339a0="" class="d-table">
                                                <div data-v-f2a183a6="" class="d-table-tr" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                                    ...
                                                    <div class="d-table-th w-3"><?php echo e(__('Unit Price')); ?></div>
                                                ...
                                                <!-- <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                    ...
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6=""><?php echo e($estimate->totalQuantity); ?></pre>
                                                    </div>
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6=""><?php echo e(\App\Utility::priceFormat($settings,$estimate->totalRate)); ?></pre>
                                                    </div>
                                                    <div class="d-table-td w-6">
                                                        <pre data-v-f2a183a6=""><?php echo e(\App\Utility::priceFormat($settings,$estimate->totalTaxPrice)); ?></pre>
                                                    </div>
                                                    <?php if($estimate->discount_apply==1): ?>
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6=""><?php echo e(\App\Utility::priceFormat($settings,$estimate->totalDiscount)); ?></pre>
                                                    </div>
                                                    <?php else: ?>
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6="">-</pre>
                                                    ...
                                                    <div class="d-table-td w-4 text-right">
                                                        <span><?php echo e(\App\Utility::priceFormat($settings,$estimate->getSubTotal())); ?>
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-footer">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            ...
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$estimate->getTotalDiscount())); ?></div>
                                                        </div>
                                                        <?php endif; ?>
                                                        <?php endif; ?>
                                                        ...
                                                        <!-- <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($color); ?>; border-bottom: 1px solid <?php echo e($color); ?>;">
                                                            ...
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$estimate->getSubTotal()-$estimate->getTotalDiscount()+$estimate->getTotalTax())); ?></div>
                                                        </div> -->
                                                    </div>
                                                </div>
                                            </div>
...
</html><?php /**PATH /home/mitaapps/public_html/dekomdmc/main_file/resources/views/estimate/templates/template1.blade.php ENDPATH**/ ?>