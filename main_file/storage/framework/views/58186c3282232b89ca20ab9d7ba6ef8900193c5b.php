...
<nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    <div class="scrollbar-inner">
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view dashboard')): ?>
                    <li class="nav-item">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view profile')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view hr')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view presale')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view project')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view items')): ?>
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view stock')): ?>
                    <li class="nav-item ">
                        ...
                        <div class="collapse <?php echo e((Request::segment(1) == 'stock')?'show':''); ?>" id="stock">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item <?php echo e((Request::segment(1) == 'item')?'active':''); ?>">
                                    <a class="nav-link" href="<?php echo e(route('item.prices')); ?>"><?php echo e(__('Prices')); ?></a>
                                </li>
                                <?php if(\Auth::user()->type=='company'): ?>
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view sales')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view contract')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view messenger')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view support')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view event')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view notice board')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view goal')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view notes')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view plans')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view coupon')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view order')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view email templates')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view report')): ?>
                    <li class="nav-item">
 ...
 Request::segment(1) == 'estimate-report' || Request::segment(1) == 'invoice-report' || Request::segment(1) == 'lead-report' || Request::segment(1) == 'client-report' || Request::segment(1) == 'attendance-report')?'show':''); ?>" id="report">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view constant')): ?>
                    <li class="nav-item ">
                    ...
                    <?php if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->hasPermissionTo('view settings')): ?>
                    <li class="nav-item">
