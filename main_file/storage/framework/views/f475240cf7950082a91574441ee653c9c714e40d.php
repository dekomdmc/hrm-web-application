...
<h6 class="h2 d-inline-block mb-0"><?php echo e(__('Invoice')); ?></h6>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto apply-btn">
                            ...
                            <a href="<?php echo e(route('invoice.index')); ?>" class="btn btn-outline-danger btn-sm"><?php echo e(__('Reset')); ?></a>
                        </div>
                    </div>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col">
                            <h2 class="h3 mb-0"><?php echo e(__('Manage Invoice')); ?></h2>
                        </div>
                        <?php if(\Auth::user()->type=='company'): ?>
                        <div class="col-auto">
                            <span class="create-btn">
                                <a href="#" data-url="<?php echo e(route('invoice.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Invoice')); ?>" class="btn btn-outline-primary btn-sm">
                                    <i class="fa fa-plus"></i> <?php echo e(__('Create')); ?>

                                </a>
                                <a href="<?php echo e(route('invoice.create')); ?>" data-url="<?php echo e(route('invoice.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Invoice')); ?>" class="btn btn-outline-primary btn-sm">
                ...
                <div class="table-responsive py-4">
                    <table class="table table-flush" id="datatable-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td><a class="btn btn-outline-primary btn-sm" href="<?php echo e(route('invoice.show',\Crypt::encrypt($invoice->id))); ?>"><?php echo e(\Auth::user()->invoiceNumberFormat($invoice->invoice_id)); ?></a></td>
                                <?php if(\Auth::user()->type!='client'): ?>
                                ...
                                <td class="table-actions text-right">
                                    <a href="<?php echo e(route('invoice.show',\Crypt::encrypt($invoice->id))); ?>" class="table-action" data-toggle="tooltip" data-original-title="<?php echo e(__('View')); ?>">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <?php if(\Auth::user()->type=='company'): ?>
                                    <a href="#!" data-url="<?php echo e(route('invoice.edit',$invoice->id)); ?>" class="table-action" data-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Edit Invoice')); ?>">
                                        <i class="far fa-edit"></i>
                                    </a>

                                    <a href="#!" class="table-action table-action-delete" data-toggle="tooltip" data-original-title="<?php echo e(__('Delete')); ?>" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="document.getElementById('invoice-delete-form-<?php echo e($invoice->id); ?>').submit();">
                                        <i class="fas fa-trash"></i>
                                    </a>
                                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['invoice.destroy', $invoice->id],'id'=>'invoice-delete-form-'.$invoice->id]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mitaapps/public_html/dekomdmc/main_file/resources/views/invoice/index.blade.php ENDPATH**/ ?>